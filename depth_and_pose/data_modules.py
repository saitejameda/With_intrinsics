...
class VideosDataModule(LightningDataModule):
    ...
    def __init__(self, hparams):
        ...
        # data loader
        if hparams.model_version == 'w1'or hparams.model_version == 'w2' or hparams.model_version == 'L':
    ...
    def train_dataloader(self):
        sampler = RandomSampler(self.train_dataset,
                                replacement=True,
                                num_samples=self.hparams.hparams.batch_size 
                                * self.hparams.hparams.epoch_size)
